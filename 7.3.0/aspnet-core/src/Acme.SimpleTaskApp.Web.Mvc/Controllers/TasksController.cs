...
namespace Acme.SimpleTaskApp.Controllers
{
    public class TasksController : SimpleTaskAppControllerBase
    {
        ...
        public TasksController(ITaskAppService taskAppService, ILookupAppService lookupAppServices)
        {
            _taskAppService = taskAppService;
            _lookupAppService = lookupAppServices;
        }
        ...
        public async Task<ActionResult> Index(GetAllTasksInput input)
        {
            ...
            {
                SelectedTaskState = (TaskState?)input.State
            };
            return View(model);
        }
    ...
    public class IndexViewModel
    {
        ...
        public string GetTaskLabel(Acme.SimpleTaskApp.Tasks.TaskListDto task)
        {
            switch (task.State)
            {
                case (byte)TaskState.Open:
